...
public:
    RealisticEspressoDemo() {
        ...
        std::cout << "Simulating espresso extraction with realistic random particle distribution" << std::endl;
        std::cout << std::endl;
    }
...
private:
    std::shared_ptr<CoffeeBed> create_realistic_coffee_bed() {
        std::cout << "Creating realistic coffee bed with proper particle distribution..." << std::endl;
    ...
    std::shared_ptr<PhysicsSolver> create_physics_solver(
        ...
        std::cout << "  Enhanced extraction rate: " << params.extraction_rate << " s⁻¹" << std::endl;
    ...
    void run_realistic_simulation(
...
#else
        std::cout << "VTK export disabled - install VTK for realistic ParaView visualization" << std::endl;
#endif
        std::cout << std::endl;
        ...
        for (int step = 0; step < total_steps; step++) {
            ...
            if (step % report_interval == 0 || step == total_steps - 1) {
                ...
                std::cout << " | Extraction: " << std::setprecision(2) << std::setw(5) << extraction_yield << "%";
        ...
        std::cout << "Open brewing_realistic_simulation.pvd in ParaView for realistic visualization" << std::endl;
#endif
        std::cout << std::endl;
    }
    
    void display_realistic_results(
        std::shared_ptr<CoffeeBed> bed,
        std::shared_ptr<WaterFlow> flow) {
        ...
        std::cout << "  Flow uniformity: " << std::fixed << std::setprecision(3)
                  << (avg_velocity / max_velocity) << " (closer to 1.0 = more uniform)" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "  Minimum size: " << std::fixed << std::setprecision(0) 
                  << min_size * 1e6 << " microns" << std::endl;
        std::cout << "  Maximum size: " << std::fixed << std::setprecision(0) 
                  << max_size * 1e6 << " microns" << std::endl;
        std::cout << "  Average size: " << std::fixed << std::setprecision(0) 
                  << avg_size * 1e6 << " microns" << std::endl;
        std::cout << std::endl;
        ...
        if (extraction_uniformity > 0.8) {
            ...
            std::cout << "  Recommendation: Check grind distribution and tamping technique" << std::endl;
        }
        ...
        std::cout << "2. Open ParaView and load: ./demo_realistic_output/brewing_realistic_simulation.pvd" << std::endl;
        ...
        std::cout << "8. Compare with spiral demo - notice the realistic random distribution!" << std::endl;
        ...
        std::cout << "Realistic particle distribution with " << particles.size() << " particles" << std::endl;
