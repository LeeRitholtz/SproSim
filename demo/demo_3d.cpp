...
public:
    Realistic3DEspressoDemo() {
        ...
        std::cout << "Simulating espresso extraction with realistic 3D particle distribution" << std::endl;
        std::cout << std::endl;
    }
...
private:
    std::shared_ptr<CoffeeBed> create_realistic_3d_coffee_bed() {
        ...
        std::cout << "Placing " << total_particles << " particles with realistic distribution..." << std::endl;
    ...
    void run_3d_simulation(
...
#else
        std::cout << "VTK export disabled - install VTK for enhanced ParaView visualization" << std::endl;
#endif
        std::cout << std::endl;
        ...
        std::cout << "Open brewing_3d_simulation.pvd in ParaView for realistic visualization" << std::endl;
#endif
        std::cout << std::endl;
    }
    
    void display_3d_results(
        std::shared_ptr<CoffeeBed> bed,
        std::shared_ptr<WaterFlow> flow) {
        ...
        std::cout << "2. Open ParaView and load: ./demo_3d_output/brewing_3d_simulation.pvd" << std::endl;
        std::cout << "3. Click 'Apply' to load the enhanced time series data" << std::endl;
        std::cout << "4. Create sphere glyphs to visualize particles with realistic distribution" << std::endl;
        std::cout << "5. Color particles by 'extraction_state' to see extraction progress" << std::endl;
        std::cout << "6. Use cross-sections (Filters → Slice) to see different depth layers" << std::endl;
